...
// Niger North: 23.52° N , South: 11.7° N, West: 0.17° E, East: 16° E \*
// //[4.2, 2.7], // Southwest corner Nigeria
// [13.9, 14.7] // Northeast corner Nigeria

const nigeriaBounds = [
    [11.7, 0.17], // Southwest corner Niger
    [23.52, 16]  // Northeast corner Niger
...
function initializeMap(center = null, zoom = null, bounds = null) {
    if (!map) {
        ...
        if (center && zoom) {
            ...
            //map.setView([9.8838, 5.9231], 6); Nigeria // Default center and zoom
            map.setView([17.61, 8.085], 6); // Niger default center and Zoom
        }
...
initializeMap();
### Added function
// NEW FUNCTION: Asks for BBOX and sets map view to the centroid
function promptForBbox() {
    let minLon = prompt("Please enter the minimum longitude (min_lon):");
    let minLat = prompt("Please enter the minimum latitude (min_lat):");
    let maxLon = prompt("Please enter the maximum longitude (max_lon):");
    let maxLat = prompt("Please enter the maximum latitude (max_lat):");
    ...
    if (!isNaN(minLon) && !isNaN(minLat) && !isNaN(maxLon) && !isNaN(maxLat)) {
        ...
        // Set the map view to the centroid with a default zoom level
